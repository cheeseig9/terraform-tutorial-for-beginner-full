...
resource "aws_internet_gateway" "internet_gateway" {
  #attach from resource "aws_vpc" "vpc" at Line 2
...
resource "aws_subnet" "public_subnet_az1" {
  ...
  #vpc_id: attach from resource "aws_vpc" "vpc" at Line 2
  vpc_id                  = aws_vpc.vpc.id  
  cidr_block              = var.public_subnet_az1_cidr
  #availability_zone: attach from data source to get all az in region
